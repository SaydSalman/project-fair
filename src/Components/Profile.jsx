      ...
      <Collapse in={open}>
        <div className='row shadow p-5 justify-content-center mt-3' id="example-collapse-text">
          <label className='text-center' >
            ...
            {existingImage == "" ? <img className='rounded-circle' style={{ width: '200px', height: '200px' }} src={preview ? preview : upload} alt="uploaded image" /> :
              <img className='rounded-circle' style={{ width: '200px', height: '200px' }} src={preview ? preview : `${SERVER_URL}/uploads/${existingImage}`} alt="uploaded image" />}
          </label>
          <div className='mt-3'><input placeholder='Enter Your Github URL' className='form-control' value={userData.github} onChange={e => setUserData({ ...userData, github: e.target.value })} type="text" /></div>
          <div className='mt-3'><input placeholder='Enter Your Linkedin URL' className='form-control' value={userData.linkedin} onChange={e => setUserData({ ...userData, linkedin: e.target.value })} type="text" /></div>
